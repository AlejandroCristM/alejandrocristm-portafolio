  ...
  return (
    <section className="flex flex-col text-center">
      ...
      <picture className="flex flex-col items-center rounded-full px-5">
        <img src={foto} className=" w-1/2 rounded-full md:w-1/3" alt="Foto personal"/>
      </picture>
      <h3 className="mt-2">{totalYears + " años"}</h3>
      <div className="flex font-medium justify-center mt-3">
        <a href="https://github.com/AlejandroCristM"><GoMarkGithub className="icon text-black" /></a>
        <a href=""><GoMail className="icon text-black" /></a>
        <a href="https://www.linkedin.com/in/alejandrocristm/"><GoBriefcase className="icon text-black" /></a>
      </div>
